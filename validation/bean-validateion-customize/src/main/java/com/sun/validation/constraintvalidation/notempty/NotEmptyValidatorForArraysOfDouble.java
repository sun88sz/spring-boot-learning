...
*/
public class NotEmptyValidatorForArraysOfDouble implements CustomerConstraintValidator<NotEmpty, double[]> {
	 ...
	 */
	@Override
	public boolean doIsValid(double[] array, ConstraintValidatorContext constraintValidatorContext) {
		if ( array == null ) {
			return false;
		}
