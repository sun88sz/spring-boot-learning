...
public class NotEmptyValidatorForCollection implements CustomerConstraintValidator<NotEmpty, Collection> {
	 ...
	 */
	@Override
	public boolean doIsValid(Collection collection, ConstraintValidatorContext constraintValidatorContext) {
		if ( collection == null ) {
			return false;
		}
