...
*/
public class NotEmptyValidatorForArraysOfFloat implements CustomerConstraintValidator<NotEmpty, float[]> {
	 ...
	 */
	@Override
	public boolean doIsValid(float[] array, ConstraintValidatorContext constraintValidatorContext) {
		if ( array == null ) {
			return false;
		}
