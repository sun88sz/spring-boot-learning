 ...
 */
public class NotEmptyValidatorForArraysOfBoolean implements CustomerConstraintValidator<NotEmpty, boolean[]> {
	 ...
	 */
	@Override
	public boolean doIsValid(boolean[] array, ConstraintValidatorContext constraintValidatorContext) {
		if ( array == null ) {
			return false;
		}
