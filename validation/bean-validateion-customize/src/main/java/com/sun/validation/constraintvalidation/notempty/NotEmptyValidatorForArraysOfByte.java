 ...
 */
public class NotEmptyValidatorForArraysOfByte implements CustomerConstraintValidator<NotEmpty, byte[]> {
	 ...
	 */
	@Override
	public boolean doIsValid(byte[] array, ConstraintValidatorContext constraintValidatorContext) {
		if ( array == null ) {
			return false;
		}
