 ...
 */
public class NotEmptyValidatorForArraysOfChar implements CustomerConstraintValidator<NotEmpty, char[]> {
	 ...
	 */
	@Override
	public boolean doIsValid(char[] array, ConstraintValidatorContext constraintValidatorContext) {
		if ( array == null ) {
			return false;
		}
